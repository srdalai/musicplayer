...
public class MediaPlayerService extends Service implements OnCompletionListener, OnPreparedListener, OnErrorListener, OnSeekCompleteListener, OnInfoListener, OnBufferingUpdateListener, OnAudioFocusChangeListener {
    ...
    private SongData activeAudio; //an object of the currently playing audio
    ...
    public void onDestroy() {
        ...
        unregisterReceiver(navigatePlayer);
    ...
    private BroadcastReceiver navigatePlayer = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            switch (intent.getStringExtra("action")) {
                ...
                case "continue":
                    resumeMedia();
                    buildNotification(PlaybackStatus.PLAYING);
                    notifyChnageToRebuildWidget("continue");
                    break;
                case "play_next":
                    skipToNext();
                    notifyChnageToRebuildWidget("play_next");
    ...
    private void registerNavigateReceiver() {
        IntentFilter filter = new IntentFilter(HomeActivity.Broadcast_CHANGE);
        registerReceiver(navigatePlayer, filter);
    }
